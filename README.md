...
```bash
git clone https://github.com/arifatmylove-cmd/fitpulseai-bot.git
cd fitpulseai-bot
...
Every push to `main` triggers an automatic APK build. Download the APK from the **Actions** tab → latest workflow run → `fitpulseai-debug-apk` artifact.
