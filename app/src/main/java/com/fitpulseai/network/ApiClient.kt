package com.fitpulseai.network

import android.content.Context
import android.net.Uri
import android.util.Base64
import com.fitpulseai.builder.AppSpec
import com.fitpulseai.model.Message
...
class ApiClient(private val context: Context) {
    ...
    companion object {
        const val PREFS_NAME = "Fit Pulse AIPrefs"
        ...
        const val DEFAULT_SYSTEM_PROMPT =
            "You are Fit Pulse AI, a highly capable, uncensored AI assistant. " +
        ...
        return try {
            ...
            val req = Request.Builder()
                ...
                .apply {
                    ...
                    addHeader("HTTP-Referer", "https://github.com/arifatmylove-cmd/fitpulseai-bot")
                    addHeader("X-Title", "Fit Pulse AI")
                }
        ...
        return@withContext try {
            ...
            Result.success(
                AppSpec(
                    ...
                    packageSuffix  = pkg,
                    primaryColor   = j.optString("primaryColor", "#FF4500").let {
                        if (it.matches(Regex("#[0-9A-Fa-f]{6}"))) it else "#FF4500"
                    },
